...
const newItems = [
  ...
  { name: "Self Evaluation Score", key: "Self Evaluation Score" }
];
  ...
  columns={[
    ...
    },
    {
      ...
      render: (text, record) => {
        ...
        if (record.key === "Self Evaluation Score") {
          return <p className="mb-0">{getSelfAssemnetScrore('teacherForm')}</p>;
        }
        // Default behavior for other rows
        return <p className="mb-0">{GetSingleForms?.teacherForm[text]}</p>;
      },
    },
    {
      ...
      render: (text, record) => {
        ...
        // Default behavior for other rows
        return <p className="mb-0">{GetSingleForms?.observerForm[text]}</p>;
      },
    },
  ]}
/>
